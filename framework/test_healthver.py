...
def main():
    ...
    logs_dir = os.path.join(script_dir, "outcome_healthver", "logs_healthver")
    os.makedirs(logs_dir, exist_ok=True)

    # 1. Determine which claim to process (Serial Processing)
    # Track progress by reading processed_claims.txt
    outcome_dir = os.path.join(script_dir, "outcome_healthver")
    ...
    test_file_path = os.path.join(data_dir, "healthver_sample_100.jsonl")
